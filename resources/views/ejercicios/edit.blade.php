...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-[#0f172a] mt-2">Editar ejercicio</h1>
        <p class="text-sm text-neutral-500 mt-1">Modifica los datos del ejercicio.</p>
    </div>
        ...
        <form method="POST" action="{{ route('ejercicios.update', $ejercicio) }}" class="space-y-5">
            ...
            <div>
                <label for="nombre" class="block text-sm font-medium text-neutral-700 mb-1">
                    Nombre del ejercicio <span class="text-red-500">*</span>
                </label>
                <input
                    id="nombre"
                    type="text"
            ...
            <div>
                <label for="grupo_muscular" class="block text-sm font-medium text-neutral-700 mb-1">
                    Grupo muscular <span class="text-neutral-400 text-xs">(opcional)</span>
                </label>
                <input
                    id="grupo_muscular"
                    type="text"
                    name="grupo_muscular"
                    value="{{ old('grupo_muscular', $ejercicio->grupo_muscular) }}"
                    class="w-full px-4 py-2.5 rounded-lg border border-neutral-300 focus:border-[#facc15] focus:ring-2 focus:ring-[#facc15]/20 transition outline-none"
                >
