...
<div class="max-w-4xl mx-auto">
    ...
    {{-- Cabecera --}}
    <div class="mb-8">
        <h1 class="font-bebas text-4xl text-[#0f172a] tracking-wide pb-1">NUEVO ENTRENAMIENTO</h1>
        <p class="text-sm text-neutral-500 mt-1">Añade los ejercicios, series, repeticiones y peso utilizados.</p>
    </div>
...
<script>
    ...
    function eliminarEjercicio(boton) {
        ...
        const lista = document.getElementById('listaEjercicios');
        const mensajeVacio = document.getElementById('mensajeVacio');
        if (lista.children.length === 0) mensajeVacio.style.display = 'block';
    }
